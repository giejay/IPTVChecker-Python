...
> [!TIP]
> **A GUI version is now available: [IPTV Checker](https://github.com/kristofferR/IPTVChecker)** — a complete rewrite with a graphical interface, better performance, and more features.
